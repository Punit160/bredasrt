                    ...
                    <div class="card  card-tabs">
                        <div class="card-header p-0 pt-1">
                            <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " id="custom-tabs-two-home-tab" data-toggle="pill" href="#custom-tabs-two-home" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true">Assigned Complaints</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped text-center d-block " style="overflow-x: auto;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-lg1" data-id="{{$complaint->id}}">
                                                        <i class="fas fa-pencil" style="color:blue"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p><span style="font-weight:bold">Assigned Remarks</span>&nbsp - &nbsp {{ $complaint->assign_remarks }}</span></p>
                                                ...
                                                <td class="">
                                                    ...
                                                    <p><span style="font-weight:bold">Approved By</span>&nbsp - &nbsp {{ $complaint->approve_by }}</span></p>
                                                    <p><span style="font-weight:bold">Approved Remarks</span>&nbsp - &nbsp {{ $complaint->approve_remarks }}</span></p>
        ...
        <div class="modal fade" id="modal-lg1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{route('save-approvevendor-complaint')}}">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Approve Complaint</label>
                                        <select name="approval" id="approval" class="form-control select2" style="width: 100%;">
                                            <option value="">Select</option>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="approve_remarks" id="" class="form-control"></textarea>
                                    </div>
                                </div>
                                <!-- Hidden input field to store the data-id -->
                                <input type="hidden" name="complaint_id" id="complaint_id1">
                            </div>
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<script>
    $(document).ready(function() {
        ...
        $('#modal-lg1').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var complaintId = button.data('id'); // Extract info from data-id attribute

            // Update the hidden input field in the modal
            var modal = $(this);
            modal.find('#complaint_id1').val(complaintId);
        });
    });
</script>
<!-- /.content-wrapper -->
