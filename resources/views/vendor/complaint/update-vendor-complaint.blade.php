        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header bg-dark">
                    ...
                    @endforeach
                    @endif
                    <form method="post" action="{{ route('update-vendor-complaint') }}" enctype="multipart/form-data">
                        @csrf
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <ul>
                                        ...
                                        <li>
                                        Site- {{ $complaint->site }} </li>
                                        </li>
                                        <li>
                                        WorkOrder- {{ $complaint->workorder }} </li>
                                        </li>
                                        <li>
                                ...
                                <div class="col-md-6">
                                    <ul>
                                        ...
                                        <li>
                                            Complaint - {{ $complaint->complaint}} </li>
                                        </li>
