    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-default ">
                ...
                <form action="{{route('save-jammu-survey')}}" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <input type="number" min="1" name="saral_id" id="saral_id" class="form-control" list="pia" required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="application_no" id="Application" class="form-control" list="Application" required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" name="empanelled_agency" id="Empanelled Agency" class="form-control" list="Empanelled Agency" required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" name="beneficiary" id="Name of Beneficiary " class="form-control" list="Name of Beneficiary " required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="mobile" id="Mobile Number" class="form-control" list="Mobile Number" required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" name="installation_village" class="form-control" list="Village of installation" required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" name="installation_dsitrict" class="form-control" list="District of installation" required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" name="required_pump" id="Required Pump" class="form-control" list="Required Pump">
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" name="pump_sub_type" id="Pump Sub Type" class="form-control" list="Pump Sub Type" required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="pump_capacity" id="Pump Capacity (HP)" class="form-control" list="Pump Capacity (HP)" required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="water_depth" id="Water Depth Level(ft) " class="form-control" list="Water Depth Level(ft) " required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="number" min="1" name="head_pump" id="Head Of Pump Meter" class="form-control" list="Head Of Pump Meter" required>
                            ...
                            <div class="col-lg-4 col-md-6  col-12 form-group">
                                ...
                                <input type="text" name="controller_type" id="Controller Type" class="form-control" list="Controller Type" required>
