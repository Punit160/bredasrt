            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update-kusumc-complaint') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-12 my-2 col-sm-12">
                                  ...
                                  <div class="form-group col-md-12 my-2 col-sm-12">
                                    ...
                                    <select name="solved"  class="form-control select2">
                                ...
                                <div class="form-group col-md-12 my-2 col-sm-12">
                                    <label>Remarks</label>
                                    <textarea class="form-control" name="solved_remark" required></textarea>
                                </div>
                                <div class="col-md-12 my-2 col-sm-12">
