...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      <form action="{{ route('save-ongrid') }}" method="POST">
        @csrf
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-3 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="tel" name="contact_number" id="contactNum" class="form-control">
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-3 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="number" name="invoice_no" id="invoiceNum" class="form-control">
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-3 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="text" name="material_supply" id="materialSuply" class="form-control">
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-3 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="date" name="material_supply_date" id="materialSuppDate" class="form-control">
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-3 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="text" name="material_payment" id="materialPay" class="form-control">
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-3 col-sm-12">
                <div class="form-group">
                  <label>FIRM</label>
                  <input type="text" name="firm" id="firm" class="form-control">
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-3 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="tel" name="contractor_number" id="contractorNum" class="form-control">
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-3 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="text" name="meter_status" id="meterStatus" class="form-control">
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="text" name="payment_85" id="pay85" class="form-control">
                </div>
              </div>
