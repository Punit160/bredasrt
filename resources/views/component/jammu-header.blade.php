  ...
  <div class="wrapper">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item sidesEle  hidden-mobile">
          <div class="user-panel  d-flex">
            ...
            <div class="info">
              <a href="#" class="d-block text-white">{{$state}}</a>
            </div>
          </div>
        </li>
        <li class="nav-item sidesEle ">
    ...
    <aside class="main-sidebar sidebar-dark-secondary elevation-4"
      style="background-color:rgb(51, 50, 50) !important; height: 100vh !important; position: fixed;">
        ...
        <span class="brand-text text-white">KLK Ventures - {{$state[0] }}</span>
        ...
        <nav>
          <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-flat" data-widget="treeview" role="menu"
            data-accordion="false">
                          ...
                          <li class="nav-item sidesEle bord ">
                            <a href="{{route('jammu-swp-dash')}}" class="nav-link  p-2  ">
                                <i class="nav-icon fas fa-home "></i>
                                <p class="text-white ">
                                    SWP Dashboard
                                </p>
                           ...
                           <li class="nav-item sidesEle ">
                            <a href="{{route('view-jammu-srt')}}" class="nav-link">
                        ...
                        <li class="nav-item sidesEle bord activePage">
                            <a href="#" class="nav-link p-2">
                                ...
                                <p class="text-white">{{$state}} Registeration<i class="fas fa-angle-left right"></i></p>
                            </a>
                            <ul class="nav nav-treeview">

                            <li class="nav-item sidesEle bord  ">
                                    <a href="{{route('add-jk-registration')}}" class="nav-link   p-2  ">
                                        <i class="fas fa-arrow-right nav-icon" style="font-size: small;"></i>
                                        <p class="text-white ">
                                            Add {{$state}} Registeration
                                        </p>
                                    </a>
                                </li>
                                <li class="nav-item sidesEle bord  ">
                                    <a href="{{route('view-jk-registration')}}" class="nav-link   p-2  ">
                                        <i class="fas fa-arrow-right nav-icon" style="font-size: small;"></i>
                                        <p class="text-white ">
                                            View {{$state}} Registeration
                                        </p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item sidesEle bord ">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item sidesEle bord  ">
                                    <a href="{{route('add-jammu-survey')}}" class="nav-link   p-2  ">
                                        <i class="fas fa-arrow-right nav-icon" style="font-size: small;"></i>
                                        <p class="text-white ">
                                            Add Survey
                                        </p>
                                ...
                                <li class="nav-item sidesEle bord  ">
                                    <a href="{{route('view-jammu-survey')}}" class="nav-link   p-2  ">
                                        <i class="fas fa-arrow-right nav-icon" style="font-size: small;"></i>
                                        <p class="text-white ">
                                            View Survey
                                        </p>
                            ...
                            <a href="#" class="nav-link p-2">
                                <i class="nav-icon fas fa-poll-h"></i>
                                <p class="text-white">Material Status<i class="fas fa-angle-left right"></i></p>
                            </a>
                            <ul class="nav nav-treeview">

                            <li class="nav-item sidesEle bord  ">
                                    <a href="{{route('add-material')}}" class="nav-link   p-2  ">
                                        <i class="fas fa-arrow-right nav-icon" style="font-size: small;"></i>
                                        <p class="text-white ">
                                            Add Material Status
                                        </p>
                                ...
                                <li class="nav-item sidesEle bord  ">
                                    <a href="{{route('view-material')}}" class="nav-link   p-2  ">
                                        <i class="fas fa-arrow-right nav-icon" style="font-size: small;"></i>
                                        <p class="text-white ">
