        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header bg-dark">
                    ...
                    @endforeach
                    @endif
                    <form method="post" action="{{ route('update-ssl-complaint') }}" enctype="multipart/form-data">
                        @csrf
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <ul>
                                        ...
                                        <li>
                                        Block- {{ $complaint->block }} </li>
                                        </li>
                                        <li>
                                        Panchayat- {{ $complaint->panchyat }} </li>
                                        </li>
                                        <li>
                                ...
                                <div class="col-md-6">
                                    <ul>
                                        <li>
                                            Name- {{ $complaint->beneficiary_name}} </li>
                                        </li>
                                         <li>
                                            Mobile - {{ $complaint->contact_no}} </li>
                                        </li>
                                        <li>
