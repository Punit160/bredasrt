...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      <form action="{{route('save-power')}}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-3">
                <div class="form-group">
                  ...
                  <input type="number" name="serial_num" id="serial_num" class="form-control">
                </div>
              </div>
              <div class="col-12 col-md-6 col-lg-3 mb-3">
                <div class="form-group">
                  <label for="empanelled_agency">Empanelled Agency</label>
                  <input type="text" name="empanelled_agency" id="empanelled_agency" class="form-control">
                </div>
              </div>
              <div class="col-12 col-md-6 col-lg-3 mb-3">
                <div class="form-group">
              ...
              <div class="col-12 col-md-6 col-lg-3 mb-3">
                <div class="form-group">
                  ...
                  <input type="tel" name="beneficiary_contact" id="beneficiary_contact" class="form-control">
                </div>
              </div>
              <div class="col-12 col-md-6 col-lg-3 mb-3">
                <div class="form-group">
                  <label for="beneficiary_gender">Beneficiary Gender</label>
                  <input type="text" name="beneficiary_gender" id="beneficiary_gender" class="form-control">
                </div>
              </div>
              <div class="col-12 col-md-6 col-lg-3 mb-3">
                <div class="form-group">
              ...
              <div class="col-12 mb-3">
                <div class="form-group">
                  ...
                  <textarea name="beneficiary_address" id="beneficiary_address" class="form-control"></textarea>
                </div>
              </div>
              ...
              <div class="col-12 col-md-6 col-lg-3 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" name="material_dispatch" id="material_dispatch" class="form-control">
                </div>
              </div>
              <div class="col-12 col-md-6 col-lg-3 mb-3">
                <div class="form-group">
                  <label for="material_dispatch_date">Material Dispatch Date</label>
                  <input type="date" name="material_dispatch_date" id="material_dispatch_date" class="form-control">
                </div>
              </div>
              <div class="col-12 col-md-6 col-lg-3 mb-3">
                <div class="form-group">
                  <label for="installation_status">Installation Status</label>
                  <input type="text" name="installation_status" id="installation_status" class="form-control">
                </div>
              </div>
              ...
              <div class="col-12 col-md-6 col-lg-4 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" name="inspection_status" id="inspection_status" class="form-control">
                </div>
              </div>
              <div class="col-12 col-lg-4 mb-3">
                <div class="form-group">
                  <label for="inspection_status_date">Date of Site Inspection</label>
                  <input type="date" name="inspection_status_date" id="inspection_status_date" class="form-control">
                </div>
              </div>
