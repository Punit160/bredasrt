       ...
       <div class="row mt-3 mb-3">
        ...
        <div class="col-md-6 col-12  ">
         <div class="card cardHover">
             <a @if($state == 'bihar') href="{{route('dashboard')}}"  @elseif($state == 'jammu')  href="{{route('jammu-dash')}}" @  href="#" @endif style="text-decoration:none;color:black">
        ...
        <div class="col-md-6 col-12   ">
         <div class="card cardHover">
              <a @if($state == 'bihar') href="{{route('dashboard')}}"  @elseif($state == 'jammu')  href="{{route('add-jk-registration')}}"   @else href="#" @endif style="text-decoration:none;color:black">
        ...
        <div class="col-md-6 col-12 mt-3">
         <div class="card cardHover">
         <a @if($state == 'bihar') href="{{route('bssl-dashboard')}}"  @elseif($state == 'jammu')  href="#"   @else href="#" @endif style="text-decoration:none;color:black">
        ...
        <div class="col-md-6 col-12  mt-3">
         <div class="card cardHover">
          <img src="{{asset('dist/img/portable.jpg')}}" style="width: 100%; height: 260px;; filter: grayscale(1)">
          <p class="text-center"
           style="font-weight: bold; font-family: Georgia, 'Times New Roman', Times, serif; padding-top: 10px;">Solar
