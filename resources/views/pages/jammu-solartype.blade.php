     ...
     <div class="row mt-3 p-2">
      <div class="col-md-6 col-12">
       ...
       <div class="row mt-3 mb-3">
        ...
        <div class="col-md-6 col-12   ">
         <div class="card cardHover">
              <a href="{{route('jammu-swp-dash')}}" style="text-decoration:none;color:black">
        ...
        <div class="col-md-6 col-12 mt-3">
         <div class="card cardHover">
         <a @if($state == 'jammu') href="{{route('jammu-ssl-dash')}}"  style="text-decoration:none;color:black" @elseif($state == 'kashmir') href="{{route('jammu-ssl-dash')}}"  style="text-decoration:none;color:black" @endif >
        ...
        <div class="col-md-6 col-12  mt-3">
         <div class="card cardHover">
           <a style="text-decoration:none;color:black; filter: grayscale(1)"  >
