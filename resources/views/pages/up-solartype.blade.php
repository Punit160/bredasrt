   ...
   @media screen and (max-width:800px) {
    ...
    .notUse {
     display: none;
      ...
      .mycards::-webkit-scrollbar-thumb:hover {
         background: #b30000; 
      }
  </style>
 </head>
   ...
   <div class="row">
    <div class="col-12">
     <h2 class="text-center pt-3  md:text-xl text-sm"
      ...
      Project Under <span style="color: brown; text-shadow: 1px 1px black;text-transform:uppercase">UP</span> Government
     </h2>
     <div class="row p-2">
      <div class="col-md-6 col-12 mycards" style="height: 600px; overflow-y: auto;">

       <div class="row mt-3 mb-3">
        <div class="col-md-6 col-12  ">
         <div class="card cardHover">
             <a  href="{{route('jammu-dash')}}"  style="text-decoration:none;color:black">
        ...
        <div class="col-md-6 col-12   ">
         <div class="card cardHover">
              <a  href="#"  style="text-decoration:none;color:black; filter: grayscale(1)">
        ...
        <div class="col-md-6 col-12 mt-3">
         <div class="card cardHover">
         <a href="{{route('up-ssl-dashboard')}}"style="text-decoration:none;color:black">
        ...
        <div class="col-md-6 col-12 mt-3">
         <div class="card cardHover">
         <a href="{{route('ongrid-dash')}}"style="text-decoration:none;color:black">
          <img src="{{asset('dist/img/street.webp')}}" style="width: 100%; height: 260px;"> 
          <p class="text-center"
           style="font-weight: bold; font-family: Georgia, 'Times New Roman', Times, serif; padding-top: 10px;">On Grid</p>
            </a>
         </div>
        </div>
        <div class="col-md-6 col-12  mt-3">
         <div class="card cardHover">
         <a href="{{route('offgrid-dash')}}"style="text-decoration:none;color:black">
          <img src="{{asset('dist/img/portable.jpg')}}" style="width: 100%; height: 260px;">
          <p class="text-center"
           style="font-weight: bold; font-family: Georgia, 'Times New Roman', Times, serif; padding-top: 10px;">Off Grid</p>
           </a>
         </div>
        </div>
            <div class="col-md-6 col-12  mt-3">
         <div class="card cardHover">
         <a href="{{route('powerpack-dash')}}"style="text-decoration:none;color:black">
          <img src="{{asset('dist/img/portable.jpg')}}" style="width: 100%; height: 260px;">
          <p class="text-center"
           style="font-weight: bold; font-family: Georgia, 'Times New Roman', Times, serif; padding-top: 10px;">Power Pack</p>
           </a>
         </div>
        </div>
                <div class="col-md-6 col-12  ">
         <div class="card cardHover">
             <a  href="{{route('kusumb-dash')}}"  style="text-decoration:none;color:black">
          <img src="{{asset('dist/img/portable.jpg')}}" style="width: 100%; height: 260px;">
          <p class="text-center"
           style="font-weight: bold; font-family: Georgia, 'Times New Roman', Times, serif; padding-top: 10px;">Kusum B</p>
           </a>
         </div>
        </div>
        <div class="col-md-6 col-12   ">
         <div class="card cardHover">
              <a href="{{route('kusumc-dash')}}" style="text-decoration:none;color:black">
          <img src="{{asset('dist/img/portable.jpg')}}" style="width: 100%; height: 260px;">
          <p class="text-center"
           style="font-weight: bold; font-family: Georgia, 'Times New Roman', Times, serif; padding-top: 10px;">Kusum C</p>
            </a>
         </div>
        </div>
       </div>
      ...
      <div class="col-md-6 col-12 mt-3 notUse ">
       <div class="card p-3" style="min-height: 600px !important; position:relative;">
        <h3 class="text-center p-2" style="display: inline; font-weight: bold;  ">
         सौर ऊर्जा:
         प्राकृतिक
