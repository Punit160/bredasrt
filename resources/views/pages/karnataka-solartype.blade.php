   ...
   <div class="row">
    <div class="col-12">
     <h2 class="text-center pt-3  md:text-xl text-sm"
      ...
      Project Under <span style="color: brown; text-shadow: 1px 1px black;text-transform:uppercase">Karnataka</span> Government
     </h2>
      ...
      <div class="col-md-6 col-12">
       ...
       <div class="row mt-3 mb-3">
        ...
        <div class="col-md-6 col-12 mt-3">
         <div class="card cardHover">
         <a href="{{route('jammu-ssl-dash')}}"style="text-decoration:none;color:black">
